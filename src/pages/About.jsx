                    ...
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
                        ...
                        <div className="md:w-6/12 flex flex-col justify-start">
                            ...
                            <p className="text-gray-300 text-lg leading-relaxed max-w-xl">
                                ...
                                . We simplify book discovery with curated tools, a clean and intuitive interface, and reliable data from the Open Library API. Our mission is to make exploring books effortless — whether you’re a casual reader or a lifelong learner. From timeless classics to hidden gems, DevGriffins Book Explorer helps you find stories that inspire, educate, and stay with you.
                            </p>
